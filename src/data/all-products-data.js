...
export const All_PRODUCTS_DATA = [
  ...
  },
  {
    ...
    color: 'Poppy Red',
    price: 'C$85.00',
    description: `TThe Momento Candleholder celebrates the timeless form of classic candleholders, originally designed for portability from room to room. Handcrafted with precision by artisans in Portugal through slip-casting and glazing, the JH39 Candleholder is available in four colors inspired by Hayon’s artwork. Azure and Poppy Red offer vibrant, statement hues, while Ivory and Red Brown introduce rich, sophisticated tones to interiors.`,
